...
2. Install **Cheat Engine** if you haven’t already.
...
**Warning**: This mod involves memory manipulation, which can be risky. Always back up your game files before use. I’ve tested it on my setup, but as a novice, I can’t guarantee it’s error-free. Use caution and report any issues!
